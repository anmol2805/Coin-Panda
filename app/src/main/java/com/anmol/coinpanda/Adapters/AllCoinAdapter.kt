 ...
 */
class AllCoinAdapter(internal var c: Context, internal var allcoins: List<Allcoin>, private val mitemClickListener: ItemClickListener): RecyclerView.Adapter<AllCoinAdapter.MyViewHolder>(){
